...
#         pass
    ...
    if TITLE_PLOTS == 'yes':
        ...
        pass
    if SAVE_PLOTS == 'yes':
        plt.savefig(fig_folder+'/ptNo'+str(datapt)+'_filters_timeseries_{}_comparison.pdf'.format(velname),
...
def plot_hist_timeseries(data, u1, u_out_plot, time_cname,
    ...
    if 'TITLE_PLOTS' == 'yes':
        ...
        pass
    if SAVE_PLOTS == 'yes':
        plt.savefig(fig_folder+'/ptNo'+str(datapt)+'_timeseries_{}_comparison.pdf'.format(velname),
                bbox_inches='tight', pad_inches=plotpad)
    else:
        pass
    if SHOW_PLOTS == 'yes':
    ...
    if 'TITLE_PLOTS' == 'yes':
        ...
        pass
    if SAVE_PLOTS == 'yes':
        plt.savefig(fig_folder+'/ptNo'+str(datapt)+'_hist_{}_comparison.pdf'.format(velname),
                bbox_inches='tight', pad_inches=plotpad)
    else:
        pass
    if SHOW_PLOTS == 'yes':
...
#     ylim_max = 1e2
    ...
    if 'TITLE_PLOTS' == 'yes':
        ...
        pass
    if SAVE_PLOTS == 'yes':
        plt.savefig(fig_folder+'/ptNo'+str(datapt)+'_PSD_{}.pdf'.format(velname),
                bbox_inches='tight', pad_inches=plotpad)
    else:
        pass
    if SHOW_PLOTS == 'yes':
...
def despike_UKDE_1D(data, fs, R_cut, S_cut, time_cname, vel_cname,
